...
(2026-08-25)
- **4 ElevenLabs voice candidates locked, A/B/C/D comparison run — all on Eleven v3, default/automatic settings:** Daniel Dark ("Crime Narrator"), Ralf Benz ("Premium Audiobook"), Hannes ("Grounded and Intimate"), Romolus ("The Storyteller from Ried"). No manual Stability/Similarity/Style/Speaker Boost values used — v3's default/automatic voice control for all 4, identical test text (30–40s passage from the real script, plain paragraph breaks, no SSML). IDs and full plan in `content/voice/2026-08-19/scene1-voice-comparison-plan.md`. (An earlier draft of this documentation incorrectly stated the comparison ran on Eleven Multilingual v2 with specific manual settings — corrected same-day after user clarification; no such settings were ever used.)
- **Pilot channel voice decided: Hannes, Voice ID `GZckiELWRyqX481UWTDl`, Eleven v3**, winner of the direct v3 comparison above. **Not yet a permanent, unchangeable channel standard** — that lock happens after the pilot Hook validates the choice. Decision + rationale in `content/voice/2026-08-19/scene1-voice-comparison-plan.md` ("Decision" section).
- **Final Scene 1 Hook VO recorded — Take 01 accepted.** Verbatim Hook text (script's "Hook (0:00–0:40)" section; the `[Atmosphäre...]` stage direction excluded from spoken text as a non-spoken production note), Eleven v3 default/automatic settings, `scene1-hook-vo-hannes-v3-take01.mp3` saved to `content/voice/2026-08-25/scene1-hook-vo/`. Full brief in `content/voice/2026-08-25/scene1-hook-vo/hook-vo-production-brief.md`. **No audio bed, no VO-timestamp/shot-timing work, and no new Remotion code started yet** — next step is timestamp extraction from Take 01, per the voice-first workflow.
- Committed and pushed as `2bf695d` ("Select Hannes voice and finalize Scene 1 hook VO").
